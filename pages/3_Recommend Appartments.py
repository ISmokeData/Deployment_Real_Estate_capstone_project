...
location_df = pickle.load(open('artifacts/location_distance.pkl','rb'))

cosine_sim1 = pickle.load(open('artifacts/cosine_sim1.pkl','rb'))
cosine_sim2 = pickle.load(open('artifacts/cosine_sim2.pkl','rb'))
cosine_sim3 = pickle.load(open('artifacts/cosine_sim3.pkl','rb'))
